...
#define SIMD128_CRANKSHAFT_TYPE(V)                                   \
V(FLOAT32X4, FLOAT32x4, Float32x4, float32x4, 4, float)              \
V(FLOAT64X2, FLOAT64x2, Float64x2, float64x2, 2, double)             \
V(INT32X4, INT32x4, Int32x4, int32x4, 4, int32_t)

#define SIMD128_VALUE_CLASS(TYPE, TYPEx, Type, type, lane_count, lane_type) \
  class Type final : public Simd128Value {                           \
   public:                                                           \
    static const InstanceType kInstanceType = TYPEx##_TYPE;          \
...
SIMD128_CRANKSHAFT_TYPE(SIMD128_VALUE_CLASS)
#undef SIMD128_VALUE_CLASS

#define SIMD128_NOCRANKSHAFT_TYPE(V)\
  V(BOOL64X2, Bool64x2, bool64x2, 2, bool)   \
  V(BOOL32X4, Bool32x4, bool32x4, 4, bool)   \
  V(INT16X8, Int16x8, int16x8, 8, int16_t)   \
  V(BOOL16X8, Bool16x8, bool16x8, 8, bool)   \
...
SIMD128_NOCRANKSHAFT_TYPE(SIMD128_VALUE_CLASS)
#undef SIMD128_VALUE_CLASS
