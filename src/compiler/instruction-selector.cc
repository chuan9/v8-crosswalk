...
void InstructionSelector::VisitNode(Node* node) {
  ...
  switch (node->opcode()) {
    ...
    case IrOpcode::kFloat32x4GetX:
      return MarkAsFloat32(node), VisitFloat32x4GetX(node);
    case IrOpcode::kFloat32x4GetY:
      return MarkAsFloat32(node), VisitFloat32x4GetY(node);
    case IrOpcode::kFloat32x4GetZ:
      return MarkAsFloat32(node), VisitFloat32x4GetZ(node);
    case IrOpcode::kFloat32x4GetW:
      return MarkAsFloat32(node), VisitFloat32x4GetW(node);
    ...
    case IrOpcode::kFloat64x2GetX:
      return MarkAsFloat64(node), VisitFloat64x2GetX(node);
    case IrOpcode::kFloat64x2GetY:
      return MarkAsFloat64(node), VisitFloat64x2GetY(node);
